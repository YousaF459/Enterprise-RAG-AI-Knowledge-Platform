...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": (
        "REST API documentation for the Enterprise AI Knowledge Platform. "
        "Supports multi-tenant organizations, document management, "
        "authentication, and Retrieval-Augmented Generation (RAG)."
    ),
    "VERSION": "1.0.0",
